...
path0 = Path("/home/spirob/Documents/Experiments/path_record_rmweight.txt")
...
#sc = ax.scatter(data[:,1],data[:,2],c = data[:,0],cmap = 'viridis', label = "Motor0", s=18,marker = '+')
sc = ax2.scatter(loop_blue[:,1],loop_blue[:,2],c = loop_blue[:,0], label = "Two Strings",s = 18,marker = 'o')
...
ax2.set_title("Position X via Postion Y")
ax2.legend()
